...
public class DslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class JMLAnnotationElements extends AbstractParserRuleElementFinder {
		...
		//"@requires" requires=Condition ";" & "@ensures" ensures=Condition ";"
		public UnorderedGroup getUnorderedGroup() { return cUnorderedGroup; }
	...
	public class RelationElements extends AbstractParserRuleElementFinder {
		...
		//Relation Expression:
		//	Implication (({Lower.left=current} "<" | {Greater.left=current} ">" | {Equal.left=current} "=" |
		//	{LowerEqual.left=current} "<=" | {GreaterEqual.left=current} ">=") right=Implication)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//(({Lower.left=current} "<" | {Greater.left=current} ">" | {Equal.left=current} "=" | {LowerEqual.left=current} "<=" |
		//{GreaterEqual.left=current} ">=") right=Implication)*
		public Group getGroup_1() { return cGroup_1; }
	...
	public class PrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		//	'(' Expression ')' | {FunctionCall} func=VariableOrMethodName ('(' (args+=Expression (',' args+=Expression)*)? ')')?
		//	| {Expression} Number;
		@Override public ParserRule getRule() { return rule; }
		
		//{Expression} => ('false' | isTrue?='true') | '(' Expression ')' | {FunctionCall} func=VariableOrMethodName ('('
		//(args+=Expression (',' args+=Expression)*)? ')')? | {Expression} Number
		public Alternatives getAlternatives() { return cAlternatives; }
