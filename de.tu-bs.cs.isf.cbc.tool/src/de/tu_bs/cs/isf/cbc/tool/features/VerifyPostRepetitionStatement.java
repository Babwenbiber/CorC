	...
	public void execute(ICustomContext context, IProgressMonitor monitor) {
		...
		if (pes != null && pes.length == 1) {
			...
			if (bo instanceof SmallRepetitionStatement) {
				...
				boolean prove = false;
				prove = ProveWithKey.provePostWithKey(new ConditionExtension(statement.getInvariant()).stringRepresentation,
						new ConditionExtension(statement.getGuard()).stringRepresentation, 
						new ConditionExtension(parent.getPostCondition()).stringRepresentation, vars, 
