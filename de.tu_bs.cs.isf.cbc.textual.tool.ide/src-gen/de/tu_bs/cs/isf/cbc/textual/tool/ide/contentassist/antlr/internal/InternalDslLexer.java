...
public class InternalDslLexer extends Lexer {
	...
	public final void mRULE_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30972:13: ( '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? )
			// InternalDsl.g:30972:15: '\"' ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )?
			{
			match('\"'); 
			// InternalDsl.g:30972:19: ( '\\\\' . |~ ( ( '\\\\' | '\"' ) ) )*
			loop1:
			while (true) {
				int alt1=3;
	...
	public final void mRULE_CHARACTER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30974:16: ( '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
			// InternalDsl.g:30974:18: '\\'' ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )?
			{
			match('\''); 
			// InternalDsl.g:30974:23: ( '\\\\' . |~ ( ( '\\\\' | '\\'' ) ) )*
			loop3:
			while (true) {
				int alt3=3;
	...
	public final void mRULE_HEX() throws RecognitionException {
		try {
			int _type = RULE_HEX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30976:10: ( ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )? )
			// InternalDsl.g:30976:12: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
			{
			// InternalDsl.g:30976:12: ( '0x' | '0X' )
			int alt5=2;
			...
			// InternalDsl.g:30976:24: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
			int cnt6=0;
			loop6:
			while (true) {
				int alt6=2;
			...
			// InternalDsl.g:30976:58: ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
			int alt8=2;
			...
			switch (alt8) {
				case 1 :
					// InternalDsl.g:30976:59: '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
					{
					match('#'); 
					// InternalDsl.g:30976:63: ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
					int alt7=2;
					...
					switch (alt7) {
						case 1 :
							// InternalDsl.g:30976:64: ( 'b' | 'B' ) ( 'i' | 'I' )
							{
	...
	public final void mRULE_INT() throws RecognitionException {
		try {
			int _type = RULE_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30978:10: ( '0' .. '9' ( '0' .. '9' | '_' )* )
			// InternalDsl.g:30978:12: '0' .. '9' ( '0' .. '9' | '_' )*
			{
			matchRange('0','9'); 
			// InternalDsl.g:30978:21: ( '0' .. '9' | '_' )*
			loop9:
			while (true) {
				int alt9=2;
	...
	public final void mRULE_DECIMAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30980:14: ( RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )? )
			// InternalDsl.g:30980:16: RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
			{
			mRULE_INT(); 

			// InternalDsl.g:30980:25: ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )?
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// InternalDsl.g:30980:26: ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT
					{
			...
			// InternalDsl.g:30980:58: ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
			int alt12=3;
			...
			switch (alt12) {
				case 1 :
					// InternalDsl.g:30980:59: ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' )
					{
					if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
						input.consume();
					}
					...
					break;
				case 2 :
					// InternalDsl.g:30980:87: ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' )
					{
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30982:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )* )
			// InternalDsl.g:30982:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
			{
			// InternalDsl.g:30982:11: ( '^' )?
			int alt13=2;
			...
			// InternalDsl.g:30982:44: ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
			loop14:
			while (true) {
				int alt14=2;
	...
	public final void mRULE_ML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30984:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalDsl.g:30984:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalDsl.g:30984:24: ( options {greedy=false; } : . )*
			loop15:
			while (true) {
				int alt15=2;
	...
	public final void mRULE_SL_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30986:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
			// InternalDsl.g:30986:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
			{
			match("//"); 

			// InternalDsl.g:30986:24: (~ ( ( '\\n' | '\\r' ) ) )*
			loop16:
			while (true) {
				int alt16=2;
	...
	public final void mRULE_WS() throws RecognitionException {
		try {
			int _type = RULE_WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30988:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
			// InternalDsl.g:30988:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			{
			// InternalDsl.g:30988:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
			int cnt19=0;
			loop19:
	...
	public final void mRULE_ANY_OTHER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalDsl.g:30990:16: ( . )
			// InternalDsl.g:30990:18: .
			{
			matchAny(); 
			}
