...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getJdlOperationAccess().getNameAlternatives_1_0(), "rule__JdlOperation__NameAlternatives_1_0");
			builder.put(grammarAccess.getJdlExpressionAccess().getAlternatives(), "rule__JdlExpression__Alternatives");
			...
			builder.put(grammarAccess.getJMLAnnotationAccess().getGroup_2(), "rule__JMLAnnotation__Group_2__0");
			...
			builder.put(grammarAccess.getJdlExpressionsAccess().getGroup(), "rule__JdlExpressions__Group__0");
			builder.put(grammarAccess.getJdlExpressionsAccess().getGroup_1(), "rule__JdlExpressions__Group_1__0");
			builder.put(grammarAccess.getJdlOperationAccess().getGroup(), "rule__JdlOperation__Group__0");
			builder.put(grammarAccess.getJdlExpressionAccess().getGroup_0(), "rule__JdlExpression__Group_0__0");
			builder.put(grammarAccess.getJdlForeachAccess().getGroup(), "rule__JdlForeach__Group__0");
			...
			builder.put(grammarAccess.getCbCProblemAccess().getCbcformulaAssignment_0(), "rule__CbCProblem__CbcformulaAssignment_0");
			builder.put(grammarAccess.getCbCProblemAccess().getGlobalconditionAssignment_1(), "rule__CbCProblem__GlobalconditionAssignment_1");
			builder.put(grammarAccess.getCbCProblemAccess().getJavaVariableAssignment_2(), "rule__CbCProblem__JavaVariableAssignment_2");
			builder.put(grammarAccess.getCbCProblemAccess().getRenamingAssignment_3(), "rule__CbCProblem__RenamingAssignment_3");
			...
			builder.put(grammarAccess.getJMLAnnotationAccess().getAssignableAssignment_2_1(), "rule__JMLAnnotation__AssignableAssignment_2_1");
			...
			builder.put(grammarAccess.getJdlExpressionsAccess().getExpressionsAssignment_0(), "rule__JdlExpressions__ExpressionsAssignment_0");
			builder.put(grammarAccess.getJdlExpressionsAccess().getOperatorsAssignment_1_0(), "rule__JdlExpressions__OperatorsAssignment_1_0");
			builder.put(grammarAccess.getJdlExpressionsAccess().getExpressionsAssignment_1_1(), "rule__JdlExpressions__ExpressionsAssignment_1_1");
			builder.put(grammarAccess.getJdlOperationAccess().getNameAssignment_1(), "rule__JdlOperation__NameAssignment_1");
			builder.put(grammarAccess.getJdlForeachAccess().getNameAssignment_1(), "rule__JdlForeach__NameAssignment_1");
			...
			builder.put(grammarAccess.getCbCProblemAccess().getUnorderedGroup(), "rule__CbCProblem__UnorderedGroup");
