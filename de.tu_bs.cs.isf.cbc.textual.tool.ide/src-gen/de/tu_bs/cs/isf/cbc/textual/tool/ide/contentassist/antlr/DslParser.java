...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBlockJavaMixAccess().getAlternatives_2(), "rule__BlockJavaMix__Alternatives_2");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getAlternatives_1(), "rule__JavaBlockStatement__Alternatives_1");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getAlternatives_1(), "rule__BlockJavaStatement__Alternatives_1");
			...
			builder.put(grammarAccess.getBlockJavaMixAccess().getGroup(), "rule__BlockJavaMix__Group__0");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getGroup(), "rule__JavaBlockStatement__Group__0");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getGroup_1_0(), "rule__JavaBlockStatement__Group_1_0__0");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getGroup_1_0_0(), "rule__JavaBlockStatement__Group_1_0_0__0");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getGroup(), "rule__BlockJavaStatement__Group__0");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getGroup_1_0(), "rule__BlockJavaStatement__Group_1_0__0");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getGroup_1_0_0(), "rule__BlockJavaStatement__Group_1_0_0__0");
			builder.put(grammarAccess.getBlockJavaTupleAccess().getGroup(), "rule__BlockJavaTuple__Group__0");
			builder.put(grammarAccess.getBlockJavaTupleAccess().getGroup_1(), "rule__BlockJavaTuple__Group_1__0");
			builder.put(grammarAccess.getJavaBlockTupleAccess().getGroup(), "rule__JavaBlockTuple__Group__0");
			builder.put(grammarAccess.getJavaBlockTupleAccess().getGroup_1(), "rule__JavaBlockTuple__Group_1__0");
			...
			builder.put(grammarAccess.getBlockStatementAccess().getBlockJavaMixAssignment_5(), "rule__BlockStatement__BlockJavaMixAssignment_5");
			builder.put(grammarAccess.getBlockJavaMixAccess().getJavaBlockStatementAssignment_2_0(), "rule__BlockJavaMix__JavaBlockStatementAssignment_2_0");
			builder.put(grammarAccess.getBlockJavaMixAccess().getBlockJavaStatementAssignment_2_1(), "rule__BlockJavaMix__BlockJavaStatementAssignment_2_1");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getLeadingAssignment_1_0_0_0(), "rule__JavaBlockStatement__LeadingAssignment_1_0_0_0");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getBodyAssignment_1_0_0_1(), "rule__JavaBlockStatement__BodyAssignment_1_0_0_1");
			builder.put(grammarAccess.getJavaBlockStatementAccess().getBodyAssignment_1_1(), "rule__JavaBlockStatement__BodyAssignment_1_1");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getLeadingAssignment_1_0_0_0(), "rule__BlockJavaStatement__LeadingAssignment_1_0_0_0");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getBodyAssignment_1_0_0_1(), "rule__BlockJavaStatement__BodyAssignment_1_0_0_1");
			builder.put(grammarAccess.getBlockJavaStatementAccess().getBodyAssignment_1_1(), "rule__BlockJavaStatement__BodyAssignment_1_1");
			builder.put(grammarAccess.getBlockJavaTupleAccess().getBlockStatementAssignment_1_0(), "rule__BlockJavaTuple__BlockStatementAssignment_1_0");
			builder.put(grammarAccess.getBlockJavaTupleAccess().getJavaStatementAssignment_1_1(), "rule__BlockJavaTuple__JavaStatementAssignment_1_1");
			builder.put(grammarAccess.getJavaBlockTupleAccess().getJavaStatementAssignment_1_0(), "rule__JavaBlockTuple__JavaStatementAssignment_1_0");
			builder.put(grammarAccess.getJavaBlockTupleAccess().getBlockStatementAssignment_1_1(), "rule__JavaBlockTuple__BlockStatementAssignment_1_1");
