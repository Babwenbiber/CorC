...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCodeStringAccess().getAlternatives_3(), "rule__CodeString__Alternatives_3");
			builder.put(grammarAccess.getVariableStringAccess().getAlternatives_1(), "rule__VariableString__Alternatives_1");
			builder.put(grammarAccess.getVariableStringAccess().getAlternatives_1_1_1(), "rule__VariableString__Alternatives_1_1_1");
			builder.put(grammarAccess.getVariableStringAccess().getAlternatives_1_1_1_0_1_1(), "rule__VariableString__Alternatives_1_1_1_0_1_1");
			builder.put(grammarAccess.getVariableStringAccess().getAlternatives_1_1_1_0_1_2_2(), "rule__VariableString__Alternatives_1_1_1_0_1_2_2");
			...
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getAlternatives(), "rule__VariableOrMethodName__Alternatives");
			...
			builder.put(grammarAccess.getJMLImplicationAccess().getAlternatives_1_0(), "rule__JMLImplication__Alternatives_1_0");
			builder.put(grammarAccess.getJMLConcatAccess().getAlternatives_1_0(), "rule__JMLConcat__Alternatives_1_0");
			builder.put(grammarAccess.getJMLForeachAccess().getAlternatives(), "rule__JMLForeach__Alternatives");
			builder.put(grammarAccess.getJMLExistsAccess().getAlternatives(), "rule__JMLExists__Alternatives");
			builder.put(grammarAccess.getJMLRelationAccess().getAlternatives_1_0(), "rule__JMLRelation__Alternatives_1_0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getAlternatives_1_0(), "rule__JMLMultiMathOperation__Alternatives_1_0");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getAlternatives_1_0(), "rule__JMLAddMathOperation__Alternatives_1_0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getAlternatives(), "rule__JMLPrimaryExpression__Alternatives");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getAlternatives_0_1_0(), "rule__JMLPrimaryExpression__Alternatives_0_1_0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getAlternatives_2_3(), "rule__JMLPrimaryExpression__Alternatives_2_3");
			...
			builder.put(grammarAccess.getCodeStringAccess().getGroup_3_0(), "rule__CodeString__Group_3_0__0");
			builder.put(grammarAccess.getCodeStringAccess().getGroup_3_0_2(), "rule__CodeString__Group_3_0_2__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup(), "rule__VariableString__Group__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1(), "rule__VariableString__Group_1_1__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1_1_0(), "rule__VariableString__Group_1_1_1_0__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1_1_0_1(), "rule__VariableString__Group_1_1_1_0_1__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1_1_0_1_2(), "rule__VariableString__Group_1_1_1_0_1_2__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1_1_1(), "rule__VariableString__Group_1_1_1_1__0");
			builder.put(grammarAccess.getVariableStringAccess().getGroup_1_1_1_1_3(), "rule__VariableString__Group_1_1_1_1_3__0");
			...
			builder.put(grammarAccess.getJMLWhileExpressionAccess().getGroup(), "rule__JMLWhileExpression__Group__0");
			builder.put(grammarAccess.getJMLWhileExpressionAccess().getGroup_1(), "rule__JMLWhileExpression__Group_1__0");
			builder.put(grammarAccess.getJMLAnnotationAccess().getGroup(), "rule__JMLAnnotation__Group__0");
			builder.put(grammarAccess.getJMLAnnotationAccess().getGroup_1(), "rule__JMLAnnotation__Group_1__0");
			builder.put(grammarAccess.getJMLAnnotationAccess().getGroup_1_0(), "rule__JMLAnnotation__Group_1_0__0");
			builder.put(grammarAccess.getJMLAnnotationAccess().getGroup_1_1(), "rule__JMLAnnotation__Group_1_1__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup(), "rule__LoopInvariantAnnotation__Group__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup_1(), "rule__LoopInvariantAnnotation__Group_1__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup_1_0(), "rule__LoopInvariantAnnotation__Group_1_0__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup_1_1(), "rule__LoopInvariantAnnotation__Group_1_1__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup_1_1_3(), "rule__LoopInvariantAnnotation__Group_1_1_3__0");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getGroup_1_2(), "rule__LoopInvariantAnnotation__Group_1_2__0");
			...
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getGroup_0(), "rule__VariableOrMethodName__Group_0__0");
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getGroup_0_1(), "rule__VariableOrMethodName__Group_0_1__0");
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getGroup_1(), "rule__VariableOrMethodName__Group_1__0");
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getGroup_1_1(), "rule__VariableOrMethodName__Group_1_1__0");
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getGroup_1_1_1(), "rule__VariableOrMethodName__Group_1_1_1__0");
			...
			builder.put(grammarAccess.getImplicationAccess().getGroup_1_0_1(), "rule__Implication__Group_1_0_1__0");
			...
			builder.put(grammarAccess.getRelationAccess().getGroup_1_0_5(), "rule__Relation__Group_1_0_5__0");
			...
			builder.put(grammarAccess.getQualifiedExpressionAccess().getGroup(), "rule__QualifiedExpression__Group__0");
			builder.put(grammarAccess.getQualifiedExpressionAccess().getGroup_1(), "rule__QualifiedExpression__Group_1__0");
			builder.put(grammarAccess.getQualifiedExpressionAccess().getGroup_1_0(), "rule__QualifiedExpression__Group_1_0__0");
			builder.put(grammarAccess.getQualifiedExpressionAccess().getGroup_1_0_0(), "rule__QualifiedExpression__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getPrimaryExpressionAccess().getGroup_2_3_0_1(), "rule__PrimaryExpression__Group_2_3_0_1__0");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getGroup_2_3_0_1_1(), "rule__PrimaryExpression__Group_2_3_0_1_1__0");
			...
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup(), "rule__JMLImplication__Group__0");
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup_1(), "rule__JMLImplication__Group_1__0");
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup_1_0_0(), "rule__JMLImplication__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup_1_0_1(), "rule__JMLImplication__Group_1_0_1__0");
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup_1_0_2(), "rule__JMLImplication__Group_1_0_2__0");
			builder.put(grammarAccess.getJMLImplicationAccess().getGroup_1_0_3(), "rule__JMLImplication__Group_1_0_3__0");
			builder.put(grammarAccess.getJMLConcatAccess().getGroup(), "rule__JMLConcat__Group__0");
			builder.put(grammarAccess.getJMLConcatAccess().getGroup_1(), "rule__JMLConcat__Group_1__0");
			builder.put(grammarAccess.getJMLConcatAccess().getGroup_1_0_0(), "rule__JMLConcat__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLConcatAccess().getGroup_1_0_1(), "rule__JMLConcat__Group_1_0_1__0");
			builder.put(grammarAccess.getJMLForeachAccess().getGroup_1(), "rule__JMLForeach__Group_1__0");
			builder.put(grammarAccess.getJMLExistsAccess().getGroup_1(), "rule__JMLExists__Group_1__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup(), "rule__JMLRelation__Group__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1(), "rule__JMLRelation__Group_1__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_0(), "rule__JMLRelation__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_1(), "rule__JMLRelation__Group_1_0_1__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_2(), "rule__JMLRelation__Group_1_0_2__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_3(), "rule__JMLRelation__Group_1_0_3__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_4(), "rule__JMLRelation__Group_1_0_4__0");
			builder.put(grammarAccess.getJMLRelationAccess().getGroup_1_0_5(), "rule__JMLRelation__Group_1_0_5__0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getGroup(), "rule__JMLMultiMathOperation__Group__0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getGroup_1(), "rule__JMLMultiMathOperation__Group_1__0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getGroup_1_0_0(), "rule__JMLMultiMathOperation__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getGroup_1_0_1(), "rule__JMLMultiMathOperation__Group_1_0_1__0");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getGroup_1_0_2(), "rule__JMLMultiMathOperation__Group_1_0_2__0");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getGroup(), "rule__JMLAddMathOperation__Group__0");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getGroup_1(), "rule__JMLAddMathOperation__Group_1__0");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getGroup_1_0_0(), "rule__JMLAddMathOperation__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getGroup_1_0_1(), "rule__JMLAddMathOperation__Group_1_0_1__0");
			builder.put(grammarAccess.getJMLQualifiedExpressionAccess().getGroup(), "rule__JMLQualifiedExpression__Group__0");
			builder.put(grammarAccess.getJMLQualifiedExpressionAccess().getGroup_1(), "rule__JMLQualifiedExpression__Group_1__0");
			builder.put(grammarAccess.getJMLQualifiedExpressionAccess().getGroup_1_0(), "rule__JMLQualifiedExpression__Group_1_0__0");
			builder.put(grammarAccess.getJMLQualifiedExpressionAccess().getGroup_1_0_0(), "rule__JMLQualifiedExpression__Group_1_0_0__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_0(), "rule__JMLPrimaryExpression__Group_0__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_0_1(), "rule__JMLPrimaryExpression__Group_0_1__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_1(), "rule__JMLPrimaryExpression__Group_1__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_2(), "rule__JMLPrimaryExpression__Group_2__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_2_3_0(), "rule__JMLPrimaryExpression__Group_2_3_0__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_2_3_0_1(), "rule__JMLPrimaryExpression__Group_2_3_0_1__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_2_3_0_1_1(), "rule__JMLPrimaryExpression__Group_2_3_0_1_1__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_2_3_1(), "rule__JMLPrimaryExpression__Group_2_3_1__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_3(), "rule__JMLPrimaryExpression__Group_3__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_4(), "rule__JMLPrimaryExpression__Group_4__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_5(), "rule__JMLPrimaryExpression__Group_5__0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getGroup_6(), "rule__JMLPrimaryExpression__Group_6__0");
			...
			builder.put(grammarAccess.getJMLWhileExpressionAccess().getAnnotationAssignment_1_0(), "rule__JMLWhileExpression__AnnotationAssignment_1_0");
			builder.put(grammarAccess.getJMLWhileExpressionAccess().getWhileAssignment_1_1(), "rule__JMLWhileExpression__WhileAssignment_1_1");
			builder.put(grammarAccess.getJMLAnnotationAccess().getRequiresAssignment_1_0_2(), "rule__JMLAnnotation__RequiresAssignment_1_0_2");
			builder.put(grammarAccess.getJMLAnnotationAccess().getEnsuresAssignment_1_1_2(), "rule__JMLAnnotation__EnsuresAssignment_1_1_2");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getLoopInvariantAssignment_1_0_2(), "rule__LoopInvariantAnnotation__LoopInvariantAssignment_1_0_2");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getAssignableAssignment_1_1_2(), "rule__LoopInvariantAnnotation__AssignableAssignment_1_1_2");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getAssignableAssignment_1_1_3_1(), "rule__LoopInvariantAnnotation__AssignableAssignment_1_1_3_1");
			builder.put(grammarAccess.getLoopInvariantAnnotationAccess().getDecreasesAssignment_1_2_2(), "rule__LoopInvariantAnnotation__DecreasesAssignment_1_2_2");
			builder.put(grammarAccess.getLoopInvariantAnnotationStatementAccess().getJmlAnnotationAssignment_1(), "rule__LoopInvariantAnnotationStatement__JmlAnnotationAssignment_1");
			...
			builder.put(grammarAccess.getVariantAccess().getVarAssignment_1(), "rule__Variant__VarAssignment_1");
			...
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getNameAssignment_0_0(), "rule__VariableOrMethodName__NameAssignment_0_0");
			builder.put(grammarAccess.getVariableOrMethodNameAccess().getNameAssignment_1_1_0(), "rule__VariableOrMethodName__NameAssignment_1_1_0");
			...
			builder.put(grammarAccess.getQualifiedExpressionAccess().getRightAssignment_1_1(), "rule__QualifiedExpression__RightAssignment_1_1");
			...
			builder.put(grammarAccess.getPrimaryExpressionAccess().getFuncAssignment_2_2(), "rule__PrimaryExpression__FuncAssignment_2_2");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getArgsAssignment_2_3_0_1_0(), "rule__PrimaryExpression__ArgsAssignment_2_3_0_1_0");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getArgsAssignment_2_3_0_1_1_1(), "rule__PrimaryExpression__ArgsAssignment_2_3_0_1_1_1");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getArgsAssignment_2_3_1_1(), "rule__PrimaryExpression__ArgsAssignment_2_3_1_1");
			builder.put(grammarAccess.getJMLImplicationAccess().getRightAssignment_1_1(), "rule__JMLImplication__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLConcatAccess().getRightAssignment_1_1(), "rule__JMLConcat__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLForeachAccess().getForeachAssignment_1_0(), "rule__JMLForeach__ForeachAssignment_1_0");
			builder.put(grammarAccess.getJMLForeachAccess().getTypeAssignment_1_1(), "rule__JMLForeach__TypeAssignment_1_1");
			builder.put(grammarAccess.getJMLForeachAccess().getVarAssignment_1_2(), "rule__JMLForeach__VarAssignment_1_2");
			builder.put(grammarAccess.getJMLForeachAccess().getRightAssignment_1_4(), "rule__JMLForeach__RightAssignment_1_4");
			builder.put(grammarAccess.getJMLExistsAccess().getExistsAssignment_1_0(), "rule__JMLExists__ExistsAssignment_1_0");
			builder.put(grammarAccess.getJMLExistsAccess().getTypeAssignment_1_1(), "rule__JMLExists__TypeAssignment_1_1");
			builder.put(grammarAccess.getJMLExistsAccess().getVarAssignment_1_2(), "rule__JMLExists__VarAssignment_1_2");
			builder.put(grammarAccess.getJMLExistsAccess().getRightAssignment_1_4(), "rule__JMLExists__RightAssignment_1_4");
			builder.put(grammarAccess.getJMLRelationAccess().getRightAssignment_1_1(), "rule__JMLRelation__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLMultiMathOperationAccess().getRightAssignment_1_1(), "rule__JMLMultiMathOperation__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLAddMathOperationAccess().getRightAssignment_1_1(), "rule__JMLAddMathOperation__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLQualifiedExpressionAccess().getRightAssignment_1_1(), "rule__JMLQualifiedExpression__RightAssignment_1_1");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getIsTrueAssignment_0_1_0_1(), "rule__JMLPrimaryExpression__IsTrueAssignment_0_1_0_1");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getFuncAssignment_2_2(), "rule__JMLPrimaryExpression__FuncAssignment_2_2");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getArgsAssignment_2_3_0_1_0(), "rule__JMLPrimaryExpression__ArgsAssignment_2_3_0_1_0");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getArgsAssignment_2_3_0_1_1_1(), "rule__JMLPrimaryExpression__ArgsAssignment_2_3_0_1_1_1");
			builder.put(grammarAccess.getJMLPrimaryExpressionAccess().getArgsAssignment_2_3_1_1(), "rule__JMLPrimaryExpression__ArgsAssignment_2_3_1_1");
