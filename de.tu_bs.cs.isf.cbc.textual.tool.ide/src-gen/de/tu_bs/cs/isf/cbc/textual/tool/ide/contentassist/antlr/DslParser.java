...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getJMLAnnotationAccess().getRequiresAssignment_1(), "rule__JMLAnnotation__RequiresAssignment_1");
			builder.put(grammarAccess.getJMLAnnotationAccess().getAssignableAssignment_4(), "rule__JMLAnnotation__AssignableAssignment_4");
			builder.put(grammarAccess.getJMLAnnotationAccess().getEnsuresAssignment_7(), "rule__JMLAnnotation__EnsuresAssignment_7");
